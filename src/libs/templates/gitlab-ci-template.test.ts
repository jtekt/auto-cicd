  ...
  it("generates a GitLab CI file with correct placeholders replaced", async () => {
    ...
    const project = {
      namespace: {
        ...
        path: "test-project",
        webUrl:
          "http://10.115.1.14/on-premise-k8s-cluster/fabel/auto-cicd-frontend",
        fullPath: "on-premise-k8s-cluster/fabel/auto-cicd-frontend",
      },
      repository: {
        rootRef: "main",
      },
